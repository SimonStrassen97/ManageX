...
from .views import ProjectsView, CreateProjectView, DeleteProjectView, UpdateProjectView, RetrieveProjectView, CheckProjectView
...
urlpatterns = [
    ...
    path('api/projects/retrieve/<int:id>/', RetrieveProjectView.as_view(), name='retrieve_project'),  # Retrieve a projec
    path('api/projects/check/<str:project_number>/', CheckProjectView.as_view(), name='check_project_availability'),  # Retrieve a project
