"""
Django settings for managex project.
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=5),  # Custom: 10 minutes
...
CORS_ALLOWED_ORIGINS = [
    "http://127.0.0.1:5173",  # React frontend running on Vite's default port
...
WSGI_APPLICATION = 'managex.wsgi.application'
...
# Specify the MEDIA_ROOT and MEDIA_URL settings
